...
##Peak Clock
##
##Opens Up Clock, yeah I ran out of creativity
...
@onready var task: Button = $"../../Taskbar/Clock"
...
func _on_button_press():
	...
	window_control = Global.Clock.instantiate()
	window.add_child(window_control)
	window.min_size = Vector2i(640, 360)
	window.max_size = Vector2i(1920, 1080)
	window.close_requested.connect(func(): window.queue_free(); self.disabled = false; self.text = "Clock"; task.position.y = 144)
