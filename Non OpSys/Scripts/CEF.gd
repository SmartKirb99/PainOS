...
const HOME_PAGE = "https://godotengine.org"
...
# ==============================================================================
## Callback when a page has ended to load with failure. Display an error message in a generated HTML page, using data URI. List of error are defined in the following file: gdcef/addons/gdcef/thirdparty/cef_binary/include/base/internal/cef_net_error_list.h
